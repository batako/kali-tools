...
if [ "${PACKAGE_NAME}" = "ctx" ] || [ "${PACKAGE_NAME}" = "xssh" ] || [ "${PACKAGE_NAME}" = "xscp" ] || [ "${PACKAGE_NAME}" = "xftp" ] || [ "${PACKAGE_NAME}" = "xsmb" ] || [ "${PACKAGE_NAME}" = "xgobuster" ] || [ "${PACKAGE_NAME}" = "xffuf" ]; then
